...
import { register, registerClient } from "../fetchers/user-fetcher";
...
function RegisterClient() {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if(company===""){
            setErrorMessage("Please provide company")
            return;
        }

        setLoading(true)
        const res = await registerClient(email, password, firstname, lastname, phoneNumber,company);
        setLoading(false)
                ...
                <div className="authentication-inner">
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <h5 className="mb-2"> Please register as a Wevioo client 👋</h5>
                            <br/>
                            <form onSubmit={handleSubmit} id="formAuthentication" className="mb-3" method="POST">
                                ...
                                <div className="mb-3">
                                    ...
                                    <p style={{ marginTop: "1rem" }} className="text-center"><span></span><Link to={"/Register"}><span>Create an account as Wevioo member here</span></Link></p>
                                </div>
